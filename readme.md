...
- [ADSA NANP Modeling Workshop - Model Validation](#adsa-nanp-modeling-workshop---model-validation)
  ...
  - [1. Environment Setup](#1-environment-setup)
    - [1.1 Option 1 (recommended): Run on your local machine](#11-option-1-recommended-run-on-your-local-machine)
      ...
      - [Step 2: Download the workshop repository](#step-2-download-the-workshop-repository)
      - [Step 3: Verify your environment](#step-3-verify-your-environment)
    - [1.2 Option 2: Run on Anaconda Cloud](#12-option-2-run-on-anaconda-cloud)
      - [Step 1: Register an Anaconda Cloud account](#step-1-register-an-anaconda-cloud-account)
      - [Step 2: Clone the workshop repository](#step-2-clone-the-workshop-repository)
      - [Step 3: Verify the online environment](#step-3-verify-the-online-environment)
...
#### Step 1: Register an Anaconda Cloud account
...
#### Step 3: Verify the online environment
